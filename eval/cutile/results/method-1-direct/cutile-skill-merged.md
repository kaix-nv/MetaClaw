...
_Core cuTile kernel authoring patterns including grid indexing, tile creation, TMA loads, compile-time constants, and accumulator initialization used across attention, matmul, and element-wise kernels._
...
_cuTile-specific patterns for flash attention variants: prefill FMHA, decode split-K, grouped query attention (GQA), and attention sinks, including online softmax, split-K reduction, and GQA tile layout._
