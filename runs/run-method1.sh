...
SKILL_MD="$WORKDIR/eval/cutile/results/method-1-direct/cutile-skill-merged.md"
TIMESTAMP=$(date -u +%Y%m%d-%H%M%S)
RUN_ROOT="$WORKDIR/runs/cutile-eval-method1-$TIMESTAMP"
...
mkdir -p "$RUN_ROOT"
echo "=== Method 1 (direct extraction skills) ==="
