...
This rule applies regardless of the source framework (PyTorch `nn.Module`, standalone function, Triton kernel wrapper, etc.). The reference must be the original code itself, not a reconstruction of it.
